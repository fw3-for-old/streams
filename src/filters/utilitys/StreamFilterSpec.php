...
abstract class StreamFilterSpec
{
     ...
     *  ]
     * @return  \fw3_for_old\streams\filters\utilitys\entitys\StreamFilterSpecEntity  ストリームフィルタスペックエンティティ
     */
    ...
    public static function registerConvertEncodingFilter($filter_name = StreamFilterConvertEncodingSpec::DEFAULT_FILTER_NAME)
    {
        ...
        \stream_filter_register(StreamFilterConvertEncodingSpec::registerFilterName(), '\fw3_for_old\streams\filters\ConvertEncodingFilter');
    }
     ...
     * @return  \fw3_for_old\streams\filters\utilitys\entitys\StreamFilterSpecEntity  フィルタの対象となるストリームを設定したストリームフィルタスペックエンティティ
     */
     ...
     * @return  \fw3_for_old\streams\filters\utilitys\entitys\StreamFilterSpecEntity  書き込みチェーンに適用するフィルタのリストを設定したストリームフィルタスペックエンティティ
     */
     ...
     * @return  \fw3_for_old\streams\filters\utilitys\entitys\StreamFilterSpecEntity  読み込みチェーンに適用するフィルタのリストを設定したストリームフィルタスペックエンティティ
     */
     ...
     * @return  \fw3_for_old\streams\filters\utilitys\entitys\StreamFilterSpecEntity  書き込みチェーン、読み込みチェーン双方に適用するフィルタのリストを設定したストリームフィルタスペックエンティティ
     */
     ...
     * @return  \fw3_for_old\streams\filters\utilitys\entitys\StreamFilterSpecEntity  書き込みチェーンに適用するフィルタを追加したストリームフィルタスペックエンティティ
     */
     ...
     * @param   array   $filter_parameters          ストリームフィルタに追加するパラメータ
     * @param   string  $filter_parameter_separator ストリームフィルタに追加するパラメータオプションのセパレータ
     * @return  \fw3_for_old\streams\filters\utilitys\entitys\StreamFilterSpecEntity  読み込みチェーンに適用するフィルタを追加したストリームフィルタスペックエンティティ
     */
     ...
     * @param   array   $filter_parameters          ストリームフィルタに追加するパラメータ
     * @param   string  $filter_parameter_separator ストリームフィルタに追加するパラメータオプションのセパレータ
     * @return  \fw3_for_old\streams\filters\utilitys\entitys\StreamFilterSpecEntity  書き込みチェーン、読み込みチェーン双方に適用するフィルタを追加したストリームフィルタスペックエンティティ
     */
