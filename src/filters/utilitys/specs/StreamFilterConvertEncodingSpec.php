...
namespace fw3_for_old\streams\filters\utilitys\specs;

use fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity;
...
abstract class StreamFilterConvertEncodingSpec
{
     ...
     *  ]
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity このインスタンス
     */
     ...
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity 変換後の文字エンコーディングを設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity 変換後の文字エンコーディングをUTF8として設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity 変換後の文字エンコーディングをeucJP-winとして設定したスペックエンティティ
     */
     ...
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity 変換前の文字エンコーディングを設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity 変換前の文字エンコーディングをUTF8として設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity 変換前の文字エンコーディングをeucJP-winとして設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity 変換前の文字エンコーディングをdefaultとして設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity 変換前の文字エンコーディングをautoとして設定したスペックエンティティ
     */
     ...
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity Shift_JIS出力用の設定を行ったスペックエンティティ
     */
     ...
     *
     * @param   string  $from_encoding  変換前文字列エンコーディング
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity EUC-JP出力用の設定を行ったスペックエンティティ
     */
     ...
     *
     * @param   string  $from_encoding  変換前文字列エンコーディング
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertEncodingSpecEntity UTF-8出力用の設定を行ったスペックエンティティ
     */
