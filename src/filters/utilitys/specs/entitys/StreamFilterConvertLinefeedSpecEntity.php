...
class StreamFilterConvertLinefeedSpecEntity implements StreamFilterSpecInterface
{
     ...
     *  ]
     * @return  \fw3_for_old\streams\filters\utilitys\specs\StreamFilterConvertLinefeedSpec   このインスタンス
     */
     ...
     * @return  string|\fw3_for_old\streams\filters\utilitys\specs\StreamFilterConvertLinefeedSpec    変換後の改行コード表現またはこのインスタンス
     */
     ...
     * @return  string|\fw3_for_old\streams\filters\utilitys\specs\StreamFilterConvertLinefeedSpec    変換前の改行コード表現またはこのインスタンス
     */
