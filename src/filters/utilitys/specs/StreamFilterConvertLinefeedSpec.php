...
use fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity;
...
abstract class StreamFilterConvertLinefeedSpec
{
     ...
     *  ]
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity スペックエンティティ
     */
     ...
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity 変換後の改行コード表現を設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity 変換後の改行コード表現としてCRを設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity 変換後の改行コード表現としてLFを設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity 変換後の改行コード表現としてCRLFを設定したスペックエンティティ
     */
     ...
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity 変換前の改行コード表現を設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity 変換前の改行コード表現としてCRを設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity 変換前の改行コード表現としてLFを設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity 変換前の改行コード表現としてCRLFを設定したスペックエンティティ
     */
     ...
     *
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity 変換前の改行コード表現としてALLを設定したスペックエンティティ
     */
     ...
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity Windows用の設定を行ったスペックエンティティ
     */
     ...
     *
     * @param   string  $from_linefeed  変換前改行コード表現文字
     * @return  \fw3_for_old\streams\filters\utilitys\specs\entitys\StreamFilterConvertLinefeedSpecEntity Unix系用の設定を行ったスペックエンティティ
     */
