 ...
 */
class StreamFilterConvertLinefeedSpecTest extends AbstractTest
{
    /**
    ...
    public function testRegisteredFilterName()
    {
        ...
        StreamFilterConvertLinefeedSpec::filterName(StreamFilterConvertLinefeedSpec::DEFAULT_FILTER_NAME);
    }
}
